...
#define GST_TYPE_VIDEO_SCALEX \
  (gst_video_scalex_get_type())
#define GST_VIDEO_SCALEX(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_VIDEO_SCALEX,GstVideoScalex))
#define GST_VIDEO_SCALEX_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_VIDEO_SCALEX,GstVideoScalexClass))
#define GST_IS_VIDEO_SCALEX(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_VIDEO_SCALEX))
#define GST_IS_VIDEO_SCALEX_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_VIDEO_SCALEX))
...
typedef struct _GstVideoScalex GstVideoScalex;
typedef struct _GstVideoScalexClass GstVideoScalexClass;
...
struct _GstVideoScalexClass {
  GstVideoFilterClass parent_class;
};

G_GNUC_INTERNAL GType gst_video_scalex_get_type (void);
